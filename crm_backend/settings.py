...
CSRF_TRUSTED_ORIGINS = [
    ...
    "http://127.0.0.1:5174",   # 👈 добавь
]


# # 👇 Настройки CORS
# # для разработки проще включить полный доступ:
# CORS_ALLOW_ALL_ORIGINS = True

# 🔒 Но лучше явно указать разрешённые фронты
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": [
        "rest_framework.authentication.TokenAuthentication",  # добавь токен
        "rest_framework.authentication.SessionAuthentication",
    ],
    "DEFAULT_PERMISSION_CLASSES": [
        "rest_framework.permissions.IsAuthenticated",  # чтобы токен проверялся
    ]
}
